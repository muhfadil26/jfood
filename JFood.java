...
public class JFood{
    public static void main (String[] args)
    {
       ...
       CashlessInvoice invoice1 = new CashlessInvoice (3, food1, new GregorianCalendar(2020,1,19),customer1, InvoiceStatus.Ongoing); 
       CashlessInvoice invoice2 = new CashlessInvoice (2, food2, new GregorianCalendar(2020,1,19),customer2, InvoiceStatus.Finished,promo1); 
       CashlessInvoice invoice3 = new CashlessInvoice (4, food3, new GregorianCalendar(2020,1,19),customer3, InvoiceStatus.Ongoing); 
       CashlessInvoice invoice4 = new CashlessInvoice (7, food4, new GregorianCalendar(2020,1,19),customer3, InvoiceStatus.Ongoing, promo2);
         
       CashInvoice invoicebaru1 = new CashInvoice (4, food1, new GregorianCalendar(2020,1,19),customer1, InvoiceStatus.Finished); 
       CashInvoice invoicebaru2 = new CashInvoice (5, food2, new GregorianCalendar(2020,1,19),customer2, InvoiceStatus.Finished, 13000);  
