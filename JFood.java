...
public class JFood{
    public static void main (String[] args)
    {
        ...
        CashlessInvoice invoice1 = new CashlessInvoice (4, food1, "13-03-2020",customer1, InvoiceStatus.Ongoing); 
        CashlessInvoice invoice2 = new CashlessInvoice (2, food2, "13-03-2020",customer2, InvoiceStatus.Finished,promo1); 
        CashlessInvoice invoice3 = new CashlessInvoice (2, food3, "13-03-2020",customer3, InvoiceStatus.Cancelled); 
        CashInvoice invoicebaru1 = new CashInvoice (4, food1, "3/3/2020",customer1, InvoiceStatus.Finished); 
        CashInvoice invoicebaru2 = new CashInvoice (5, food2, "3/3/2020",customer2, InvoiceStatus.Finished, 1300); 
        //CashlessInvoice invoice3 = 
        //soal baru
